...
def do_experiments(start, end, step_num):
    ...
    for i, distance in enumerate(shift_distances, 1):
        ...
        y_values = -(beta1 * x_values + beta0) / beta2
    ...
    # Plot beta0
    plt.subplot(3, 3, 1)
    plt.plot(shift_distances, beta0_list, label='Beta0', color='blue')
    ...
    # Plot beta1
    plt.subplot(3, 3, 2)
    plt.plot(shift_distances, beta1_list, label='Beta1', color='green')
    ...
    # Plot beta2
    plt.subplot(3, 3, 3)
    plt.plot(shift_distances, beta2_list, label='Beta2', color='red')
    ...
    plt.subplot(3, 3, 4)
    plt.plot(shift_distances, slope_list, label='Slope', color='purple')
    ...
    plt.subplot(3, 3, 5)
    plt.plot(shift_distances, intercept_list, label='Intercept Ratio', color='orange')
    ...
    # Plot logistic loss
    plt.subplot(3, 3, 6)
    plt.plot(shift_distances, loss_list, label='Logistic Loss', color='brown')
    ...
    # Plot margin width
    plt.subplot(3, 3, 7)
    plt.plot(shift_distances, margin_widths, label='Margin Width', color='black')
